...
export default mod<UxCheckboxInput, {}>(({ model, disabled = false, required = false, title = '', style = '', styleTags = ['m']}, { $, input, implement }) => {
    const bClass = ['h-input', 'h-input-checkbox', ...styleTags].join(' ').trim()
